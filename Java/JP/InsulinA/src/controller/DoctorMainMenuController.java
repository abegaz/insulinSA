...
public class DoctorMainMenuController implements Initializable {
    ...
    {
        Parent tableViewParent = FXMLLoader.load(getClass().getResource("../view/PatientInsert.fxml"));
    ...
    {
        Parent tableViewParent = FXMLLoader.load(getClass().getResource("../view/PatientMainView.fxml"));
        Scene tableViewScene = new Scene(tableViewParent);
        Stage window = (Stage)((Node)event.getSource()).getScene().getWindow();
        window.setScene(tableViewScene);
        window.show();
